...
namespace DC.SF.Common.Helper
{
    ...
    public class ValidatorHelper
    {
        ...
        /// <summary>  
        /// 验证字符串是否匹配正则表达式描述的规则：匹配时是否不区分大小写  
        /// </summary>  
        /// <param name="inputStr">待验证的字符串</param>  
        /// <param name="patternStr">正则表达式字符串</param>  
        ...
        /// <summary>  
        /// 验证字符串是否匹配正则表达式描述的规则：是否验证空白字符串
        /// </summary>  
        /// <param name="inputStr">待验证的字符串</param>  
        /// <param name="patternStr">正则表达式字符串</param>  
        /// <param name="ifValidateWhiteSpace">是否验证空白字符串</param>  
        /// <returns>是否匹配</returns>  
        public static bool IsMatchValidateWhiteSpace(string inputStr, string patternStr, bool ifValidateWhiteSpace)
        {
            return IsMatch(inputStr, patternStr, false, ifValidateWhiteSpace);
        }

        /// <summary>  
        /// 验证字符串是否匹配正则表达式描述的规则：区分大小写与验证空白字符串
        /// </summary>  
        /// <param name="inputStr">待验证的字符串</param>  
        /// <param name="patternStr">正则表达式字符串</param>  
        /// <param name="ifIgnoreCase">匹配时是否不区分大小写</param>  
