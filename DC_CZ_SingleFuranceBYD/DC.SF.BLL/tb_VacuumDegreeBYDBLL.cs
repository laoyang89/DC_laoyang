...
namespace DC.SF.BLL
{
	...
	/// tb_VacuumDegreeBYD
	/// </summary>
	public partial class tb_VacuumDegreeBYDBLL
    {
		private readonly tb_VacuumDegreeBYDDAL dal=new tb_VacuumDegreeBYDDAL();
		public tb_VacuumDegreeBYDBLL()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<tb_VacuumDegreeBYD> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tb_VacuumDegreeBYD> DataTableToList(DataTable dt)
		{
			List<tb_VacuumDegreeBYD> modelList = new List<tb_VacuumDegreeBYD>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tb_VacuumDegreeBYD model;
